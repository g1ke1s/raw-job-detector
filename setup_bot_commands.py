...
async def main():
    ...
    commands = [
        ...
        BotCommand("rejected", "Show last 20 system-rejected close calls"),
        BotCommand("errors", "Show last 20 scraper errors"),
        BotCommand("seniors", "Show senior-tagged jobs (not auto-sent)"),
        BotCommand("export", "Export all matches as CSV"),
